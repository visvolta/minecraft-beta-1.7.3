...
export type EntityTextureKey = 'pig'|'cow'|'sheep'|'sheepFur'|'chicken'|'zombie'|'zombiePigman'|'skeleton'|'spider'|'spiderEyes'|'creeper'|'ghast'|'ghastShooting'|'fireball'|'arrows'|'minecart'|'bowStandby'|'bowPulling0'|'bowPulling1'|'bowPulling2'|'fishingBobber'|'boat'|'goldSword'|'slime'|'wolf'|'wolfTame'|'wolfAngry'|'wolfCollar'|'squid'|'paintingKristoffer';

const PATHS: Readonly<Record<EntityTextureKey,string>>={
  pig:'/textures/entity/pig.png',cow:'/textures/entity/cow.png',sheep:'/textures/entity/sheep.png',sheepFur:'/textures/entity/sheep_fur.png',chicken:'/textures/entity/chicken.png',zombie:'/textures/entity/zombie.png',zombiePigman:'/textures/entity/zombie_pigman.png',skeleton:'/textures/entity/skeleton.png',spider:'/textures/entity/spider.png',spiderEyes:'/textures/entity/spider_eyes.png',creeper:'/textures/entity/creeper.png',ghast:'/textures/entity/ghast.png',ghastShooting:'/textures/entity/ghast_shooting.png',fireball:'/textures/entity/fireball.png',arrows:'/textures/entity/arrows.png',minecart:'/textures/entity/minecart.png',bowStandby:'/textures/items/bow_standby.png',bowPulling0:'/textures/items/bow_pulling_0.png',bowPulling1:'/textures/items/bow_pulling_1.png',bowPulling2:'/textures/items/bow_pulling_2.png',fishingBobber:'/textures/entity/fishing_bobber.png',boat:'/textures/entity/boat.png',goldSword:'/textures/items/gold_sword.png',slime:'/textures/entity/slime.png',wolf:'/textures/entity/wolf.png',wolfTame:'/textures/entity/wolf_tame.png',wolfAngry:'/textures/entity/wolf_angry.png',wolfCollar:'/textures/entity/wolf_collar.png',squid:'/textures/entity/squid.png',paintingKristoffer:'/textures/entity/painting/kristoffer_zetterstrand.png',
};
