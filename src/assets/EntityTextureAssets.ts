...
export type EntityTextureKey = 'pig'|'cow'|'sheep'|'sheepFur'|'chicken'|'zombie'|'zombiePigman'|'skeleton'|'spider'|'spiderEyes'|'creeper'|'ghast'|'ghastShooting'|'fireball'|'arrows'|'minecart'|'bowStandby'|'bowPulling0'|'bowPulling1'|'bowPulling2'|'fishingBobber'|'boat'|'paintingKristoffer';
