...
export type SemanticSoundEvent =
  ...
  | { readonly type: 'step'; readonly material: StepSoundMaterial; readonly x: number; readonly y: number; readonly z: number; readonly volume?: number }
  ...
  | { readonly type: 'random.splash'; readonly x: number; readonly y: number; readonly z: number }
