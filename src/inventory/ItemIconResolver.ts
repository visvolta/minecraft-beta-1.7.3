...
const ITEM_ALIASES: Record<string, string> = {
  ...
  // Bow and rod ship as per-state textures; the inventory icon is the
  // resting frame (Beta's `bow` / `fishingRod` icon).
  '261': 'bow_standby',
  'bow': 'bow_standby',
  ...
  '2258': 'record_blocks', 'record_blocks': 'record_blocks',
  '2259': 'record_chirp', 'record_chirp': 'record_chirp',
  '2260': 'record_far', 'record_far': 'record_far',
  '2261': 'record_mall', 'record_mall': 'record_mall',
  '2262': 'record_mellohi', 'record_mellohi': 'record_mellohi',
  '2263': 'record_stal', 'record_stal': 'record_stal',
  '2264': 'record_strad', 'record_strad': 'record_strad',
  '2265': 'record_ward', 'record_ward': 'record_ward',
  '2266': 'record_11', 'record_11': 'record_11',
  '2267': 'record_wait', 'record_wait': 'record_wait',
  // Weapons and Tools
  '268': 'wood_sword',
  '269': 'wood_shovel',
  '270': 'wood_pickaxe',
...
const BLOCK_TEXTURE_FALLBACKS: Record<string, string> = {
  // Block items whose inventory icon comes from the block texture.
  '67': '/textures/blocks/cobblestone.png',
  'cobblestone_stairs': '/textures/blocks/cobblestone.png',
  '53': '/textures/blocks/planks_oak.png',
  'wood_stairs': '/textures/blocks/planks_oak.png',
  '96': '/textures/blocks/trapdoor.png',
  'trapdoor': '/textures/blocks/trapdoor.png',
  '72': '/textures/blocks/planks_oak.png',
  'wood_pressure_plate': '/textures/blocks/planks_oak.png',
  // Fire
