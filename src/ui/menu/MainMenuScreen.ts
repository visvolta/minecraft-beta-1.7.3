...
export class MainMenuScreen extends Screen {
  ...
  public constructor(actions: MainMenuActions, settings?: GameSettings) {
    ...
    const version = document.createElement('div'); version.textContent='Minecraft Beta 1.7.3'; version.style.cssText='position:absolute;left:4px;top:4px;color:#888;z-index:10;font:10px Minecraft, monospace';
    this.logo.src='/textures/gui/minecraft_title_logo.png'; this.logo.draggable=false; this.logo.style.cssText='position:absolute;width:256px;height:64px;image-rendering:pixelated;z-index:10';
  ...
  private layout(): void {
    ...
    this.buttons[0]!.element.style.zIndex="10";
    this.buttons[1]!.element.style.zIndex="10";
    this.buttons[2]!.element.style.zIndex="10";
