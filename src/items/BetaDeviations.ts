...
export const BETA_BLOCK_DEVIATIONS: readonly BetaDeviation[] = [
  ...
  { id: 'podzol', numericId: 254, reason: 'Temporary id / intentional taiga surface: Beta has no podzol block.' },
  { id: 'coarse_dirt', numericId: 248, reason: 'Intentional taiga/OGST surface addition (not in Beta 1.7.3).' },
