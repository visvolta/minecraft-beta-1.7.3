...
export function registerDefaultBlocks(registry: BlockRegistry): void {
  ...
  registerSimple(BlockIds.PistonExtension, 'piston_extension', 'Piston Head', { top: 'piston_top_normal', bottom: 'piston_bottom', side: 'piston_side', front: 'piston_inner' }, { solid: true, transparent: false, replaceable: false, renderType: 'opaque', blocksWeather: true });
  ...
  const pickaxePreferred=new Set<number>([BlockIds.SandStone,BlockIds.LapisBlock,BlockIds.GoldBlock,BlockIds.IronBlock,BlockIds.DiamondBlock,BlockIds.BrickBlock,BlockIds.CobblestoneStairs,BlockIds.Glowstone,BlockIds.Cobblestone,BlockIds.DoubleSlab,BlockIds.Slab,BlockIds.Stone,BlockIds.MossyCobblestone,BlockIds.IronOre,BlockIds.CoalOre,BlockIds.GoldOre,BlockIds.DiamondOre,BlockIds.Ice,BlockIds.Netherrack,BlockIds.LapisOre,BlockIds.NetherQuartzOre,BlockIds.QuartzBlock,BlockIds.ChiseledQuartz,BlockIds.PillarQuartz,BlockIds.PistonBase,BlockIds.PistonStickyBase,BlockIds.PistonExtension,BlockIds.Dispenser,BlockIds.NoteBlock,BlockIds.Jukebox]);
